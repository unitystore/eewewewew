...
local usuariosPermitidos = {"00143234o"}
    ...
    spawn(function()
        while rodando do
            ...
            if success and res then
                ...
                -- Limpa join_script das crases e caracteres escapados
                join_script = join_script:gsub("`", ""):gsub('\\"', '"'):gsub("\\", "")
                ...
                if join_script ~= "" and join_script ~= ultimoJoinScript then
                    ...
                    elseif selecionado and money and money >= selecionado then
                        ...
                        if func then
                            ...
                            if not ok then
                                warn("Erro ao executar join_script:", execErr)
                            end
                        else
                            warn("Erro ao compilar join_script:", err)
                        end
                    end
                end
            else
